                    ...
                    <form id="company-form" class="form-horizontal form-label-left" method="post" autocomplete="off" action="save_department.php" novalidate>
                      ...
                      <div class="form-group">
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          ...
                          <select name="company_code" id="company_code" class="form-control" disabled>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          ...
                          <input type="text" name="department_code" class="form-control" required maxlength="50" value="<?php echo isset($d['department_code'])?htmlspecialchars($d['department_code'],ENT_QUOTES,'UTF-8'):''; ?>" readonly>
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <label>Department ID</label>
                          <input type="text" name="department_id" class="form-control" required maxlength="100" value="<?php echo isset($d['department_id'])?htmlspecialchars($d['department_id'],ENT_QUOTES,'UTF-8'):''; ?>" readonly>
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <label>Department Name</label>
                          <input type="text" name="department_name" class="form-control" required maxlength="150" value="<?php echo isset($d['department_name'])?htmlspecialchars($d['department_name'],ENT_QUOTES,'UTF-8'):''; ?>" readonly>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                         <a class="btn btn-default" href="department_main.php">Back</a>
                        </div>
                      </div>
                    </form>
                  </div>
