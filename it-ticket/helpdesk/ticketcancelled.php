...
<div class="table-responsive">
	<table class="table table-striped table-bordered table-hover" id="dataTables-ticketcancelled">
		<thead>
			<tr>
				<th>Task ID</th>
				<th>Created By</th>
		...
		$myquery = "SELECT pm_projecttasktb.id,pm_projecttasktb.srn_id,pm_projecttasktb.subject,pm_projecttasktb.description,pm_projecttasktb.deadline,
					...
					WHERE pm_projecttasktb.istask = '2' $rest AND pm_projecttasktb.statusid IN ('5') $rest2
...
<script type="text/javascript">
 $(document).ready(function() {
       $('#dataTables-ticketcancelled').DataTable({
            "aaSorting": [],
			"scrollCollapse": true,	
			"autoWidth": false,
			"responsive": true,
