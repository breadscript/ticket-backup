												...
												<div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
													<div class="inline position-relative">
														<a href="#" class="user-title-label dropdown-toggle" data-toggle="dropdown">
															<i class="ace-icon fa fa-circle <?php echo $currentColor; ?>" id="status-icon"></i>
															&nbsp;
														...
														<ul class="align-left dropdown-menu dropdown-caret dropdown-lighter">
															...
															<li>
																<a href="#" class="status-option" data-status="available">
															...
															<li>
																<a href="#" class="status-option" data-status="pending">
															...
															<li>
																<a href="#" class="status-option" data-status="inactive">
																	<i class="ace-icon fa fa-circle grey"></i>
																	&nbsp;
																	<span class="grey">Inactive</span>
																</a>
															</li>
															<li>
																<a href="#" class="status-option" data-status="deleted">
											...
											<div class="profile-user-info profile-user-info-striped">
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="username" data-type="text" data-pk="1" data-name="username" data-url="update_profile.php">
