...
include('proxy.php');
		...
		if($userlevelid == 1){
			...
			$rest2.=" AND pm_projecttasktb2.createdbyid = '$userid'";
		}
									...
									<div class="tab-pane fade in active" id="ticketlist">
										<div class="table-responsive">
											<table class="table table-striped table-bordered table-hover" id="dataTables-myticket">
												...
												$conn = connectionDB();
												$counter = 1;
												$myquery = "SELECT pm_projecttasktb2.id,pm_projecttasktb2.srn_id,pm_projecttasktb2.subject,pm_projecttasktb2.description,pm_projecttasktb2.deadline,
																   pm_projecttasktb2.startdate,pm_projecttasktb2.enddate,pm_projecttasktb2.classificationid,
																   pm_projecttasktb2.statusid,pm_projecttasktb2.priorityid,pm_projecttasktb2.createdbyid,pm_projecttasktb2.datetimecreated,
																   pm_projecttasktb2.assignee,pm_projecttasktb2.projectid,
																   sys_taskclassificationtb.classification,sys_taskstatustb.statusname,sys_priorityleveltb.priorityname,
																   sys_projecttb.projectname,pm_projecttasktb2.percentdone,sys_projecttb.clientid
															FROM pm_projecttasktb2
															LEFT JOIN sys_taskclassificationtb ON sys_taskclassificationtb.id=pm_projecttasktb2.classificationid
															LEFT JOIN sys_taskstatustb ON sys_taskstatustb.id=pm_projecttasktb2.statusid
															LEFT JOIN sys_priorityleveltb ON sys_priorityleveltb.id=pm_projecttasktb2.priorityid
															LEFT JOIN sys_projecttb ON sys_projecttb.id=pm_projecttasktb2.projectid
															WHERE pm_projecttasktb2.istask = '2' $rest AND pm_projecttasktb2.statusid IN ('1') $rest2
															ORDER BY pm_projecttasktb2.datetimecreated ASC";
