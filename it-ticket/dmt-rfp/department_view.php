                    ...
                    <form id="company-form" class="form-horizontal form-label-left" method="post" autocomplete="off" action="save_department.php" novalidate>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          ...
                          <input type="text" name="department_code" class="form-control" required maxlength="50" value="<?php echo isset($d['department_name'])?htmlspecialchars($d['department_name'],ENT_QUOTES,'UTF-8'):''; ?>" readonly>
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12">
