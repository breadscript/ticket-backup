...
$__CLEAN_URL = 'disbursement_view_oz.php';
...
if (isset($_SESSION[$__VIEW_KEY], $_SESSION[$__VIEW_EXP]) && time() <= (int)$_SESSION[$__VIEW_EXP]) {
	...
	$fallback = 'disbursement_main_oz.php';
...
// Enforce ownership: only the user who created the record can view it, unless admin user
if ($fr && !$isAdminUser && isset($_SESSION['userid']) && (string)$fr['created_by_user_id'] !== (string)$_SESSION['userid']) {
                    ...
                    <div class="x_panel">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a class="btn btn-default" href="disbursement_main_oz.php">Back</a>
                        </div>
                      </div>
                    </form>
                  </div>
