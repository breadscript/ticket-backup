...
// Fetch available requests to display in the table (created by current user only)
$requests = [];
if (isset($mysqlconn) && $mysqlconn) {
                                    ...
                                    <td>
                                      <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" style="min-width: 120px; max-width: 120px;">
                                          <li><a href="disbursement_view.php?id=<?php echo $id; ?>"><i class="fa fa-eye"></i> View</a></li>
                                          <?php if ($canEdit) { ?>
