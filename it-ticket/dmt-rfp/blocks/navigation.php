                ...
                <ul class="nav side-menu">
                  <!-- <li><a><i class="fa fa-home"></i> Disbursement <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="disbursement_main.php">Disbursement</a></li>
                      <li><a href="company_main.php">Company</a></li>
                      <li><a href="department_main.php">Department</a></li>
					  <li><a href="category_main.php">Category</a></li>
					  <li><a href="disbursement_approver_main.php">DMS Approval</a></li>
					  <li><a href="workflow_template_main.php">Workflow Approval</a></li>
                    </ul>
                  </li> -->
