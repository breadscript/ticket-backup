                    ...
                    <form id="company-form" class="form-horizontal form-label-left" method="post" autocomplete="off" action="save_company.php" novalidate>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input type="text" name="company_name" class="form-control" required maxlength="150" value="<?php echo isset($c['company_name'])?htmlspecialchars($c['company_name'],ENT_QUOTES,'UTF-8'):''; ?>">
                        </div>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                          <label>Company Code</label>
                          <input type="text" name="company_code" class="form-control" required maxlength="50" value="<?php echo isset($c['company_code'])?htmlspecialchars($c['company_code'],ENT_QUOTES,'UTF-8'):''; ?>">
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <label>Company ID</label>
                          <input type="text" name="company_ident" class="form-control" required maxlength="100" value="<?php echo isset($c['company_id'])?htmlspecialchars($c['company_id'],ENT_QUOTES,'UTF-8'):''; ?>">
                        </div>
                      </div>
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          ...
                          <input type="text" name="company_address" class="form-control" maxlength="255" value="<?php echo isset($c['company_address'])?htmlspecialchars($c['company_address'],ENT_QUOTES,'UTF-8'):''; ?>">
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <label>Company TIN</label>
                          <input type="text" name="company_tin" class="form-control" maxlength="50" value="<?php echo isset($c['company_tin'])?htmlspecialchars($c['company_tin'],ENT_QUOTES,'UTF-8'):''; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a class="btn btn-default" href="company_main.php">Cancel</a>
