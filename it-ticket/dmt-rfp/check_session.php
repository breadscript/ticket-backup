...
// Set user role based on userlevelid from session
if (!isset($_SESSION['userrole']) && isset($_SESSION['userlevelid'])) {
	$userLevel = (int)($_SESSION['userlevelid'] ?? 0);
	$_SESSION['userrole'] = $userLevel === 1 ? 'admin' : 'user';
}
?>
