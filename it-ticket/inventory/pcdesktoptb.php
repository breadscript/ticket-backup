...
?>
<style>
/* Compact table styling for PC Desktop */
#dataTables-pcdesktop {
    font-size: 12px;
}

#dataTables-pcdesktop td {
    padding: 6px 4px;
...
<table class="table table-striped table-bordered table-hover" id="dataTables-pcdesktop">
												<thead>
													<tr>						
												...
												// Query to fetch PC Desktop inventory items
												$query = "SELECT *
												FROM inv_inventorylisttb
												WHERE statusid = 0 
												AND asset_type = 'PC Desktop'
												...
												if($result && mysqli_num_rows($result) > 0) {
													...
													// No data found
													echo '<tr><td colspan="19" class="text-center"><span style="color: red; font-weight: bold;">No PC Desktop inventory items found.</span></td></tr>';
												}
												?>
												</tbody>
											</table>
...
<script type="text/javascript">
 $(document).ready(function() {
       $('#dataTables-pcdesktop').DataTable({
            "aaSorting": [],
			"scrollCollapse": true,	
			"autoWidth": false,
			"responsive": true,
