...
?>
<style>
/* Compact table styling for Tablets */
#dataTables-tablets {
    font-size: 12px;
}

#dataTables-tablets td {
    padding: 6px 4px;
...
<table class="table table-striped table-bordered table-hover" id="dataTables-tablets">
    <thead>
        <tr>
    ...
    // Query to fetch Tablet inventory items
    $query = "SELECT *
    FROM inv_inventorylisttb
    WHERE statusid = 0 
    AND asset_type = 'Tablet'
    ...
    if($result && mysqli_num_rows($result) > 0) {
        ...
        // No data found
        echo '<tr><td colspan="19" class="text-center"><span style="color: red; font-weight: bold;">No Tablet inventory items found</span></td></tr>';
    }
    ?>
    </tbody>
</table>
