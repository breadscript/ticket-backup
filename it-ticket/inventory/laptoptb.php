...
?>
<style>
/* Compact table styling for Laptop */
#dataTables-laptop {
    font-size: 12px;
}

#dataTables-laptop td {
    padding: 6px 4px;
...
<table class="table table-striped table-bordered table-hover" id="dataTables-laptop">
    <thead>
        <tr>
    ...
    // Query to fetch Laptop inventory items
    $query = "SELECT *
    ...
    if($result && mysqli_num_rows($result) > 0) {
        ...
        // No data found
        echo '<tr><td colspan="19" class="text-center"><span style="color: red; font-weight: bold;">No Laptop inventory items found.</span></td></tr>';
    }
    ?>
    </tbody>
</table>
