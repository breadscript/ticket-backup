...
?>
<style>
/* Compact table styling for Printers */
#dataTables-printers {
    font-size: 12px;
}

#dataTables-printers td {
    padding: 6px 4px;
...
<table class="table table-striped table-bordered table-hover" id="dataTables-printers">
    <thead>
        <tr>
    ...
    // Query to fetch Printer inventory items
    $query = "SELECT *
    FROM inv_inventorylisttb
    WHERE statusid = 0 
    AND asset_type = 'Printers'
    ...
    if($result && mysqli_num_rows($result) > 0) {
        ...
        // No data found
        echo '<tr><td colspan="19" class="text-center"><span style="color: red; font-weight: bold;">No Printer inventory items found</span></td></tr>';
    }
    ?>
    </tbody>
</table>
